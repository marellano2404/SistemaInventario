...
/******/ 	return __webpack_require__(__webpack_require__.s = "./angular-pdf.module.js");
        /******/
})
/************************************************************************/
/******/({

/***/ "./angular-pdf.directive.js":
                ...
                var NgPdf = exports.NgPdf = ["$window", "$document", "$log", function NgPdf($window, $document, $log) {
                    ...
                    return {
                        ...
                        templateUrl: function templateUrl(element, attr) {
                            return attr.templateUrl ? attr.templateUrl : '/Home/PdfViewer';
                        },
...
/***/ (function (module, exports, __webpack_require__) {
                ...
                var _angularPdf = __webpack_require__("./angular-pdf.directive.js");
